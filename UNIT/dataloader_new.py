...
def read_data():
    ...
    with open('./tmp_pkl_data/{}_ashrae_{}_to_{}_cl.pkl'.format(read_data_building_name, context_a, context_b),
              'wb') as w:
        pickle.dump(save_dict, w)
    print(
        'data saved at: ./tmp_pkl_data/{}_ashrae_{}_to_{}_cl.pkl'.format(read_data_building_name, context_a, context_b))
